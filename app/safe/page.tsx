			...
			<div className="flex justify-center px-10 pt-10 space-x-4 max-h-[26em]">
				<section className="grid grid-cols-1 gap-6 md:grid-cols-3">
					...
					<Card className="justify-around">
						<CardHeader>
							<CardTitle>
								<span className="text-[#52ff80]">Create</span> a PassKey Smart Wallet
					...
					<Card className="flex flex-col h-full justify-between">
						<CardHeader>
							<CardTitle>
								<span className="text-[#50ff7f]">Enable Recovery Module</span> on an
					...
					<Card className="flex flex-col h-full justify-between">
						<CardHeader>
							<CardTitle>
								<span className="text-[#50ff7f]">Add</span> World ID Account for Recovery
							</CardTitle>
						</CardHeader>
						<CardContent className="flex-grow">
							<div className="grid gap-2">
					...
					<Card>
						<CardHeader>
							<CardTitle>
								<span className="text-[#50ff7f]">Remove</span> World ID Account for Recovery
							</CardTitle>
						</CardHeader>
						<CardContent>
							{!recovering ? (<form onSubmit={handleWorldID} className="grid gap-4">
